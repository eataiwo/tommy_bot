...
echo_and_run cd "/home/pi/Github/Dexter_ROS/src/image_pipeline/camera_calibration"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/pi/Github/Dexter_ROS/src/image_pipeline/camera_calibration/setup.py" \
     \
    build --build-base "/home/pi/Github/Dexter_ROS/build/image_pipeline/camera_calibration" \
    install \
    --root="${DESTDIR-/}" \
