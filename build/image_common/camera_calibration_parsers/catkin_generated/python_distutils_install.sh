...
echo_and_run cd "/home/pi/Github/Dexter_ROS/src/image_common/camera_calibration_parsers"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/pi/Github/Dexter_ROS/src/image_common/camera_calibration_parsers/setup.py" \
    egg_info --egg-base /home/pi/Github/Dexter_ROS/build/image_common/camera_calibration_parsers \
    build --build-base "/home/pi/Github/Dexter_ROS/build/image_common/camera_calibration_parsers" \
    install \
    --root="${DESTDIR-/}" \
