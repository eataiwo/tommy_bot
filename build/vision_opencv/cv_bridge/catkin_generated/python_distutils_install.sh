...
echo_and_run cd "/home/pi/Github/Dexter_ROS/src/vision_opencv/cv_bridge"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/pi/Github/Dexter_ROS/src/vision_opencv/cv_bridge/setup.py" \
    egg_info --egg-base /home/pi/Github/Dexter_ROS/build/vision_opencv/cv_bridge \
    build --build-base "/home/pi/Github/Dexter_ROS/build/vision_opencv/cv_bridge" \
    install \
    --root="${DESTDIR-/}" \
