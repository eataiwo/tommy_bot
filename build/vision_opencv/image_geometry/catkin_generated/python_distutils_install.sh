...
echo_and_run cd "/home/pi/Github/Dexter_ROS/src/vision_opencv/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/pi/Github/Dexter_ROS/src/vision_opencv/image_geometry/setup.py" \
    egg_info --egg-base /home/pi/Github/Dexter_ROS/build/vision_opencv/image_geometry \
    build --build-base "/home/pi/Github/Dexter_ROS/build/vision_opencv/image_geometry" \
    install \
    --root="${DESTDIR-/}" \
